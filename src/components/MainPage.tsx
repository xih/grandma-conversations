    ...
    >
      <div className="max-w-md w-full space-y-6 p-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <div className="space-y-2 text-center">
          <h1
            className={`${myFont.className} text-3xl font-bold text-gray-900 dark:text-gray-100`}
          >
            Grandma Protection Service
          </h1>
          <p className={`${openSans.className}`}>
            Test the AI scam preparedness of your loved ones. Enter their info
            below and we'll give them a call.
          </p>
        </div>
